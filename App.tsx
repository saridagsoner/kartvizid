      ...
      <div className="flex-1 flex justify-center pt-[68px] md:pt-[64px] px-0 sm:px-2 md:px-6">
        <div className="max-w-[1600px] w-full flex items-start pb-12 lg:px-12">
          ...
          <main className="flex-1 flex items-start min-w-0 h-full lg:pl-4">
            ...
            <aside className={`hidden lg:block w-[600px] min-w-0 h-[calc(100vh-84px)] sticky top-[84px] overflow-hidden bg-white dark:bg-[#0f172a] transition-all duration-500 lg:ml-4 lg:mr-20 ${
