...
const CompanyFormModal: React.FC<CompanyFormModalProps> = ({ onClose, onSubmit, onDelete, initialData }) => {
    const { t } = useLanguage();
    ...
    return (
        <div className="fixed inset-0 z-[120] flex items-center justify-center sm:p-4 bg-white dark:bg-black sm:bg-black/60 sm:backdrop-blur-xl">
            <div className="bg-white dark:bg-black w-full h-full sm:max-w-[800px] sm:h-[90vh] sm:rounded-[3rem] shadow-none sm:shadow-2xl relative flex flex-col overflow-hidden">
                ...
                {/* Header */}
                <div className="px-6 py-4 sm:px-8 sm:py-5 border-b border-gray-100 dark:border-white/10 flex justify-between items-center bg-white dark:bg-black sticky top-0 z-10 shrink-0">
                    <div>
                ...
                {/* Form Body */}
                <div className="flex-1 overflow-y-auto p-6 sm:p-10 custom-scrollbar space-y-4 bg-white dark:bg-black">
