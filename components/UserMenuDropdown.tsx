...
const UserMenuDropdown: React.FC<UserMenuDropdownProps> = ({ onClose, onLogout, onOpenSettings }) => {
  return (
    <div className="absolute right-0 top-12 w-64 bg-white rounded-[2rem] shadow-2xl border border-gray-100 z-[60] py-4 animate-in slide-in-from-top-4 duration-300">
