                                ...
                                <>
                                    <div className="flex flex-col gap-3 mb-2">
                                        <button
                                            ...
                                            disabled={loading}
                                            className="w-full flex items-center justify-center gap-3 bg-white dark:bg-gray-800 border-2 border-gray-100 dark:border-white/5 py-4 rounded-2xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all font-bold text-[14px] text-gray-700 dark:text-gray-200 active:scale-[0.98] shadow-sm"
                                        >
                                            ...
                                            {mode === 'signin' ? t('auth.signin_google') || 'Google ile Giriş Yap' : t('auth.signup_google') || 'Google ile Kayıt Ol'}
                                        </button>
                                    </div>
