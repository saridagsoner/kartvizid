...
const NotificationDropdown: React.FC<NotificationDropdownProps> = ({ onClose, notifications, onAction }) => {
  const { user } = useAuth();
              ...
              >
                <div className="flex gap-5">
                  ...
                  <div className="flex-1">
                    ...
                    {/* Access nested requester data directly if available, or fallback */}
                    <p className="text-sm text-gray-600 leading-relaxed font-medium">
                      {(req as any).requester?.full_name || 'Bir kullanıcı'} iletişim bilgilerinizi görüntülemek istiyor.
                    </p>
