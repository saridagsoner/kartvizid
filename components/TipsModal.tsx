...
// TIPS definition moved inside the component for localization
    ...
    const TIPS = [
        {
            ...
            title: t('tips.tip1_title'),
            description: t('tips.tip1_desc')
        },
        {
            icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            title: t('tips.tip2_title'),
            description: t('tips.tip2_desc')
        },
        {
            icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            title: t('tips.tip3_title'),
            description: t('tips.tip3_desc')
        },
        {
            icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            title: t('tips.tip4_title'),
            description: t('tips.tip4_desc')
        },
        {
            icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            title: t('tips.tip5_title'),
            description: t('tips.tip5_desc')
        },
        {
            icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            title: t('tips.tip6_title'),
            description: t('tips.tip6_desc')
        }
    ];
